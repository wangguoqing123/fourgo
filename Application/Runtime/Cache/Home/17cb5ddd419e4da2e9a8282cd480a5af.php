...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Public/Css/Result/index.css" />
</head>
<body>
<!-- 导航栏 -->
<header>
...
<div class="content">
    ...
    <div class="showTop">
        <h2>竞赛成果</h2>
        <!-- 第一行 -->
        <?php if(is_array($JsList)): $i = 0; $__LIST__ = $JsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$one): $mod = ($i % 2 );++$i;?><div class="col-md-4">
            <div class="thumbnail">
              <img src="<?php echo ($one["img"]); ?>" alt="...">
              <div class="caption">
                <h3 class="font-center"><?php echo ($one["name"]); ?></h3>
                <p class="indents text-justify"><?php echo ($one["info"]); ?></p>
                <p>
      ...
      <div class="pages"><?php echo ($JsShow); ?></div>
    </div>
    <!-- 学生获奖结束 -->
    ...
    <h2>论文成果</h2>
        <!-- 第一行 -->
        <?php if(is_array($LwList)): $i = 0; $__LIST__ = $LwList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$one): $mod = ($i % 2 );++$i;?><div class="col-md-4">
            <div class="thumbnail">
              <img src="<?php echo ($one["img"]); ?>" alt="...">
              <div class="caption">
                <p class="indents text-justify"><?php echo ($one["info"]); ?></p>
                <p>
                  <a href="<?php echo U('Result/result');?>" class="btn btn-primary" role="button">查看</a>
                  <a href="#" class="btn btn-default" role="button">点赞</a>
                </p>
              </div>
            </div>
      ...
      <div class="pages"><?php echo ($LwShow); ?></div>
    </div>
    <!-- 学生论文结束 -->
</div>
<footer>
...
<script type="text/javascript" src="/Public/Js/Result/index.js"></script>
</body>
</html>