...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/bootstrap-fileupload.css" />

	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/jquery.gritter.css" />

	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/chosen.css" />

	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/select2_metro.css" />

	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/jquery.tagsinput.css" />

	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/clockface.css" />

	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/bootstrap-wysihtml5.css" />

	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/datepicker.css" />

	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/timepicker.css" />

	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/colorpicker.css" />

	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/bootstrap-toggle-buttons.css" />

	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/daterangepicker.css" />

	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/datetimepicker.css" />

	<link rel="stylesheet" type="text/css" href="/Application/Admin/View/media/css/multi-select-metro.css" />

	<link href="/Application/Admin/View/media/css/bootstrap-modal.css" rel="stylesheet" type="text/css"/>
	...
	<script type="text/javascript" src="/Public/xheditor/xheditor.min.js"></script>
...
<!-- END BEGIN STYLE CUSTOMIZER -->
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo U('Message/index');?>">站内消息</a>

								<i class="icon-angle-right"></i>

							</li>

							<li><a href="<?php echo U('Message/write');?>">写信</a></li>
					...
					<div class="span12">
						...
						<div class="portlet box yellow">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>附件(可选)</div>
							...
							<div class="portlet-body form">
								...
								<form action="#" class="form-horizontal">
									...
									<label class="control-label">&nbsp;</label>
										...
										<span class="alert alert-error">允许添加附件类型：word、ppt、pdf、text；图片：jpg、jpeg、gif、png、bmp</span>
					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>内容</div>
							...
							<div class="portlet-body form">
								...
								<form id="form" action="<?php echo U('Message/send');?>" autocomplete="off" class="form-horizontal" method="post">
									...
									<div class="control-group">
										...
										<div class="control-group">
												...
												<div class="controls">
													...
													<select name="user" id="select2_sample2" class="span6 select2" multiple>

														<option value=""></option>

														<optgroup label="联系人">
															<?php if(is_array($user)): foreach($user as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["username"]); ?></option><?php endforeach; endif; ?>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input type="text" name="title" class="m-wrap span12">
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<textarea name="content" class="m-wrap span12 xheditor {skin:'o2007blue'}" rows="7"></textarea>
									...
									<div class="form-actions">
										...
										<button type="submit" class="btn blue"><i class="icon-ok"></i> 发送</button>
										<input type="hidden" id="save" name="" value="<?php echo U('Message/save');?>">

										<button onclick="return submit_confirm()" type="button" class="btn green"><i class="icon-save"></i> 保存</button>

										<button onclick="window.location.href='<?php echo U('Message/index');?>' " type="reset" class="btn yellow"><i class="icon-ban-circle"></i> 取消</button>
...
<!-- END FOOTER -->
	...
	<script type="text/javascript" src="/Application/Admin/View/media/js/ckeditor.js"></script>  
	...
	<script type="text/javascript" src="/Application/Admin/View/media/js/select2.min.js"></script>

	<script type="text/javascript" src="/Application/Admin/View/media/js/wysihtml5-0.3.0.js"></script> 

	<script type="text/javascript" src="/Application/Admin/View/media/js/bootstrap-wysihtml5.js"></script>

	<script type="text/javascript" src="/Application/Admin/View/media/js/jquery.tagsinput.min.js"></script>

	<script type="text/javascript" src="/Application/Admin/View/media/js/jquery.toggle.buttons.js"></script>

	<script type="text/javascript" src="/Application/Admin/View/media/js/bootstrap-datepicker.js"></script>

	<script type="text/javascript" src="/Application/Admin/View/media/js/bootstrap-datetimepicker.js"></script>

	<script type="text/javascript" src="/Application/Admin/View/media/js/clockface.js"></script>

	<script type="text/javascript" src="/Application/Admin/View/media/js/date.js"></script>

	<script type="text/javascript" src="/Application/Admin/View/media/js/daterangepicker.js"></script> 

	<script type="text/javascript" src="/Application/Admin/View/media/js/bootstrap-colorpicker.js"></script>  

	<script type="text/javascript" src="/Application/Admin/View/media/js/bootstrap-timepicker.js"></script>

	<script type="text/javascript" src="/Application/Admin/View/media/js/jquery.inputmask.bundle.min.js"></script>   

	<script type="text/javascript" src="/Application/Admin/View/media/js/jquery.input-ip-address-control-1.0.min.js"></script>

	<script type="text/javascript" src="/Application/Admin/View/media/js/jquery.multi-select.js"></script>   

	<script src="/Application/Admin/View/media/js/bootstrap-modal.js" type="text/javascript" ></script>

	<script src="/Application/Admin/View/media/js/bootstrap-modalmanager.js" type="text/javascript" ></script> 
	...
	<script src="/Application/Admin/View/media/js/form-components.js"></script>     
