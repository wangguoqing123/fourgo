...
<head>
	...
	<link rel="stylesheet" href="/Application/Admin/View/media/css/DT_bootstrap.css" />

	<!-- END PAGE LEVEL STYLES -->

	<link rel="shortcut icon" href="/Application/Admin/View/media/image/favicon.ico" />
	<link rel="stylesheet" href="/Application/Admin/View/media/css/manage.css" />
<script type="text/javascript">
function delete_confirm(){
    event.returnValue = confirm("你确认要删除该用户吗？");
}
</script>
</head>
...
<!-- END BEGIN STYLE CUSTOMIZER -->
						...
						<ul class="breadcrumb">
							...
							<li>
								...
								<a href="<?php echo U('Manage/index');?>">管理中心</a>
							...
							<li>
								...
								<a href="<?php echo U('Manage/index');?>">用户管理</a>

								<i class="icon-angle-right"></i>

							</li>

							<li><a href="<?php echo U('Manage/index');?>">学生管理</a></li>
					...
					<div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-user"></i>学生用户</div>
							...
							<div class="portlet-body">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_2">
									...
									<?php if(is_array($list)): foreach($list as $key=>$vo): ?><tr class="odd gradeX">
											...
											<td class="hidden-480"><?php echo ($vo["age"]); ?></td>

											<td class="hidden-480">
												<?php if($vo["rank"] == 1): ?>第一步
												<?php else: ?>第三步<?php endif; ?>
											</td>

											<td class="hidden-480"><?php echo ($vo["email"]); ?></td>

											<td>
												<?php if($vo["status"] == 1): ?><span class="label label-success">正常</span>
												<?php else: ?><span class="label label-warning">繁忙</span><?php endif; ?>
											</td>

											<td>
												<a href="<?php echo U('Manage/edit',array('id'=>$vo['id']));?>" title="编辑" class="btn blue icn-only"><i class="icon-edit white"></i></a>
												<a href="<?php echo U('Manage/ban',array('id'=>$vo['id'],'status'=>$vo['status']));?>" title="禁止" class="btn yellow icn-only"><i class=" icon-ban-circle white"></i></a>
												<a href="<?php echo U('Manage/delete',array('id'=>$vo['id']));?>" onclick="return delete_confirm()" title="删除" class="btn red icn-only" ><i class="icon-remove-sign white"></i></a>
											</td>
...
<!-- END FOOTER -->
	...
	<script type="text/javascript" src="/Application/Admin/View/media/js/jquery.dataTables.js"></script>

	<script type="text/javascript" src="/Application/Admin/View/media/js/DT_bootstrap.js"></script>
	...
	<script src="/Application/Admin/View/media/js/table-managed.js"></script>     
