        ...
        initIntro: function () {
            ...
            setTimeout(function () {
                var unique_id = $.gritter.add({
                    ...
                    text: '上次登录时间为 2015-05-28 09:12:23',
                    // (string | optional) the image to display on the left
                    image: localhostPaht+'/learning/App/Admin/View/img/admin3.jpg',
            ...
            setTimeout(function () {
                ...
                var number = $('#header_task_bar .badge').text();
                number = parseInt(number);
                number = number + 2;
                $('#header_task_bar .badge').text(number);
                $('#header_task_bar').pulsate({
                    color: "#dd5131",
                    repeat: 5
                });
