...
var App = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function () {
            ...
            $('#style_color').attr("href", localhostPaht+"/learning/App/Admin/View/media/css/" + style_color + ".css");
        }
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            ...
            var el = jQuery(el); 
            el.block({
                    message: '<img src='+localhostPaht+'/learning/App/Admin/View/media/image/ajax-loading.gif align="">',
